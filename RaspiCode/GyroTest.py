...
bus = smbus.SMBus(1) # bus = smbus.SMBus(0) for rev 1
...
print "gyro_xout: ", ("%5d" % xout), " scaled: ", (xout / 131)
print "gyro_yout: ", ("%5d" % yout), " scaled: ", (yout / 131)
print "gyro_zout: ", ("%5d" % zout), " scaled: ", (zout / 131)
